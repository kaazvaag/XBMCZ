...
CXBMCApp::CXBMCApp(ANativeActivity* nativeActivity)
  ...
  , CJNIBroadcastReceiver("org/xbmc/xbmcZ/XBMCBroadcastReceiver")
  , m_wakeLock(NULL)
{
...
bool CXBMCApp::getWakeLock()
{
  ...
  m_wakeLock = new CJNIWakeLock(CJNIPowerManager(getSystemService("power")).newWakeLock("org.xbmc.xbmcZ"));
...
void CXBMCApp::SetupEnv()
{
  ...
  if (!androidPath)
    androidPath = getDir("org.xbmc.xbmcZ", 1);
